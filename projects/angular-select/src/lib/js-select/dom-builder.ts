...
export abstract class SelectDom {
  ...
  addListeners() {
    ...
    // this.tmpl.searchContainer.addEventListener('change', this.preventInternalChange); //Think about this case
    // this.tmpl.dropdownContainer.addEventListener('change', this.preventInternalChange);
